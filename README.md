...
The current version is <ins>**v0.2.0**</ins> and is compatible with Patch 1.5.0-b20638 released on 12 June 2025. Downloads for the latest version can be found [here](https://github.com/96-LB/ShadowsReanimated/releases/latest). The changelog can be found [here](Changelog.md).
